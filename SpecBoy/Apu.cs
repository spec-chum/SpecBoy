...
sealed class Apu
{
	...
	// CRITICAL FIX: Store the audio callback delegate in a field to prevent garbage collection
	private readonly SDL_AudioCallback audioCallback;
	...
	public Apu()
	{
		// CRITICAL FIX: Store the callback delegate in a field to prevent GC
	...
	private void InitializeAudio()
	{
		SDL_AudioSpec desired = new()
		{
			...
			channels = 2, // Stereo
			samples = BufferSize,
			callback = audioCallback  // Use the stored delegate
		};
